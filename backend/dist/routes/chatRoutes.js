 ...
 *         description: 서버 오류
 */
router.get('/rooms', chatController_1.getMyChatRooms);
/**
 * @swagger
 ...
 *         description: 서버 오류
 */
router.get('/room/:roomId', chatController_1.getChatRoomMessages);
/**
 * @swagger
 * /api/chat/message:
 *   post:
 ...
 *         description: 서버 오류
 */
router.get('/room/:roomId/status', chatController_1.getChatRoomStatus);
/**
 * @swagger
 ...
 *         description: 서버 오류
 */
router.get('/room/:roomId/history', chatController_1.getChatRoomHistory);
