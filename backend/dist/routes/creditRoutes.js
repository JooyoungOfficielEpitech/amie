 ...
 *         description: 서버 오류
 */
router.get('/logs', creditController_1.getCreditLogs);
/**
 * @swagger
 ...
 *         description: 서버 오류
 */
router.get('/usage-info', creditController_1.getCreditUsageInfo);
/**
 * @swagger
 * /api/credit/charge:
 *   post:
 ...
 *         description: 서버 오류
 */
router.post('/charge', creditController_1.chargeCredit);
/**
 * @swagger
 * /api/credit/use:
 *   post:
 ...
 *         description: 서버 오류
 */
router.post('/use', creditController_1.useCredit);
/**
 * @swagger
 * /api/credit/current:
 *   get:
 ...
 *         description: 서버 오류
 */
router.get('/current', creditController_1.getCurrentCredit);
