...
exports.getChatRoomHistory = exports.getChatRoomStatus = exports.sendMessage = exports.getChatRoomMessages = exports.getMyChatRooms = void 0;
...
const getChatRoomMessages = async (req, res) => {
    try {
        ...
        // 채팅방 메시지 조회 (최신 50개)
        const messages = await Message_1.default.find({ chatRoomId: roomId })
...
const getChatRoomStatus = async (req, res) => {
    try {
...
exports.getChatRoomHistory = getChatRoomHistory;
// --- End Add function --- 
